...
#define TSL1401_AO_PIN1 (ADC0_CH0_A0) // 对应第二个 TSL1401 的 AO 引脚
// TSL1401 的控制引脚定义 多个 TSL1401 建议将控制引脚直接并联
#define TSL1401_CLK_PIN (P33_5) // TSL1401 的 CLK 引脚定义
#define TSL1401_SI_PIN (P33_7)  // TSL1401 的 SI 引脚定义
...
#define TSL1401_EXPOSURE_TIME (30)       // 定义 TSL1401 曝光时间 单位 MS
